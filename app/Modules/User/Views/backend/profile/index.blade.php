                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('address',$user->permanent_address,['class'=>$errors->has('permanent_address')?'form-control is-invalid':'form-control','placeholder'=>'Permanent address','rows'=>'5']) !!}
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
