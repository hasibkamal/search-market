    ...
    <div class="card">
        <div class="card-header">
            <div class="row col-sm">
                <h5><i class="fa fa-edit"></i> Edit market</h5>
            </div>
        </div>
        {!! Form::open(['route'=>array('admin.markets.update',\App\Libraries\Encryption::encodeId($market->id)), 'method'=>'patch','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    {!! Form::select('status',[1=>'Active',0=>'Inactive'],$market->status,['class'=>$errors->has('status')?'form-control is-invalid':'form-control required']) !!}
                </div>
                <div class="col-md-12">
