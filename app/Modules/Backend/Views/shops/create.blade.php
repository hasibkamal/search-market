    ...
    <div class="card">
        <div class="card-header">
            <div class="row col-sm">
                <h5><i class="fa fa-plus-square"></i> Add Shop</h5>
            </div>
        </div>
        {!! Form::open(['route'=>'admin.shops.store', 'method'=>'post','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 form-group">
                    {!! Form::label('market_id','Market',['class'=>'font-weight-bold required-star']) !!}
                    {!! Form::select('market_id',$markets,'',['class'=>$errors->has('market_id')?'form-control is-invalid':'form-control required','placeholder'=>'Select one']) !!}
                </div>
                <div class="col-md-4 form-group">
                ...
                <div class="col-md-4 form-group">
                    ...
                    {!! Form::text('phone','',['class'=>$errors->has('phone')?'form-control is-invalid':'form-control required','placeholder'=>'Phone']) !!}
                </div>
                <div class="col-md-4 form-group">
                    {!! Form::label('proprietor','Proprietor') !!}
                    {!! Form::text('proprietor','',['class'=>$errors->has('proprietor')?'form-control is-invalid':'form-control','placeholder'=>'Proprietor']) !!}
                </div>
                <div class="col-md-4 form-group">
